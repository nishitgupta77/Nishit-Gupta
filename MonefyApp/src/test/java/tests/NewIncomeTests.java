...
public class NewIncomeTests extends BaseClass {
	...
	public void AddNewIncomeTest() throws InterruptedException, IOException
	{
		...
		newIncomePage.addNewIncome("500","Deposit");
	...
	{   
		...
		newIncomePage.addNewIncome("700","Deposit");
